        ...
        <div class="infor-top">
            ...
            <div class="col-md-3 infor-left">
                ...
                <h4>The company name,
                    ...
                    Gravas 17.</h4>
                <h5>+371 255 25 290</h5>
                <p><a href="mailto:nykzak1@email.com">nykzak1@example.com</a></p>
            </div>
            <div class="clearfix"></div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="footer-top">
            ...
            <div class="col-md-6 footer-right">
                <p>© 2021 GreySHOP. All Rights Reserved | Design by  <a href="http://w3layouts.com/" target="_blank">W3layouts</a> </p>
            </div>
            <div class="clearfix"></div>
        </div>
    </div>
